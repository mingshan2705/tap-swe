...
# page = st.sidebar.radio("Navigation", ["Scoreboard", "Add Teams", "Edit Teams", "Teams", "Add Matches", "Edit Matches", "Matches", "Data Change Log", "Clear All Data"])
...
#     # Fetch rankings and matches data
#     rankings_data = fetch_rankings()
